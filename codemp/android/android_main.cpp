...
void Sys_Error( const char *error, ... )
{
	...
	Q_vsnprintf (str, sizeof(str), error, argptr);
	va_end (argptr);
//	((void)__android_log_print(ANDROID_LOG_ERROR,"JK3", str));
	PortablePrint("Error:");
	PortablePrint(str);
	//Sys_ErrorDialog( str );
	Sys_Print( str );
