...
XCVAR_DEF( mov_spLightning,						"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( mov_rain,							"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( mov_rainDistance,					"1000",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( mov_sun,								"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( mov_sunSize,							"1",					NULL,					CVAR_ARCHIVE )
