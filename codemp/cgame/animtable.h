...
stringID_table_t animTableRpmod[MAX_ANIMATIONS+1] =
{
	//=================================================
	//HEAD ANIMS
	//=================================================
...
//===End Saber locks==================================================================
	...
	//--------------------------------
	//RPMod new animations
	//--------------------------------
	{ "BOTH_LEDGE_GRAB", 1493 },
	{ "BOTH_LEDGE_HOLD", 1494 },
	{ "BOTH_LEDGE_LEFT", 1495 },
	{ "BOTH_LEDGE_RIGHT", 1496 },
	{ "BOTH_LEDGE_MERCPULL", 1497 },
...
stringID_table_t animTableGalaxyRP[MAX_ANIMATIONS+1] =
{
	//=================================================
	//HEAD ANIMS
	//=================================================
...
//===End Saber locks==================================================================
	...
	ENUM2STRING(BOTH_CIN_49),		//# Level specific cinematic
	ENUM2STRING(BOTH_CIN_50),		//# Level specific cinematic
	ENUM2STRING(BOTH_ARMSCROSSED),
	ENUM2STRING(BOTH_CUFFEDFRONT),
	ENUM2STRING(BOTH_CUFFEDKNEES),
	ENUM2STRING(BOTH_FISTBUMP),
	ENUM2STRING(BOTH_HANDSBACK),
	ENUM2STRING(BOTH_HANDSFRONT),
	ENUM2STRING(BOTH_HANDSHEAD),
	ENUM2STRING(BOTH_HANDSHIPS),
	ENUM2STRING(BOTH_HANDSHIPS2),
	ENUM2STRING(BOTH_HANDSTAND2),
	ENUM2STRING(BOTH_HEADSCRATCH),
	ENUM2STRING(BOTH_HURT),
	ENUM2STRING(BOTH_HURT2),
	ENUM2STRING(BOTH_LAYDOWN),
	ENUM2STRING(BOTH_LEANWALL),
	ENUM2STRING(BOTH_PONDER),
	ENUM2STRING(BOTH_PONDER2),
	ENUM2STRING(BOTH_SALUTE),
	ENUM2STRING(BOTH_SITUP),
	ENUM2STRING(BOTH_ATARU),
	ENUM2STRING(BOTH_DJEMSO),
	ENUM2STRING(BOTH_JARKAI),
	ENUM2STRING(BOTH_JARKAIREVERSE),
	ENUM2STRING(BOTH_MAKASHI),
	ENUM2STRING(BOTH_SABERIDLE),
	ENUM2STRING(BOTH_SABERSTANCE),
	ENUM2STRING(BOTH_SHIEN),
	ENUM2STRING(BOTH_SORESU),
	ENUM2STRING(BOTH_MEDITATEFORCE),
	ENUM2STRING(BOTH_MEDITATION2),
	ENUM2STRING(BOTH_USEFORCE),
	ENUM2STRING(BOTH_SHIEN2),
	ENUM2STRING(BOTH_NIMAN),
	ENUM2STRING(BOTH_SHIICHO),
	ENUM2STRING(BOTH_JUYO),
	ENUM2STRING(BOTH_HANDSTAND),
	ENUM2STRING(BOTH_SITFEET),
	ENUM2STRING(BOTH_COFFEE_IDLE),
	ENUM2STRING(BOTH_COFFEE_SIP),
	ENUM2STRING(BOTH_SABERPOINT),
	ENUM2STRING(BOTH_SABERPOINT2),
	ENUM2STRING(BOTH_CARRY),
	ENUM2STRING(BOTH_LEANFRONT),
	ENUM2STRING(BOTH_GUARD),
	ENUM2STRING(BOTH_OBJECT),
	ENUM2STRING(BOTH_ANAKINKATA),
	ENUM2STRING(BOTH_ANAKINKATA2),
	ENUM2STRING(BOTH_ANAKINKATA3),
	ENUM2STRING(BOTH_GUNSPINB),
	ENUM2STRING(BOTH_GUNSPINF),
	ENUM2STRING(BOTH_GUNSPINS),
	ENUM2STRING(BOTH_PISTOLREADY),
	ENUM2STRING(BOTH_QUICKDRAW),
	ENUM2STRING(BOTH_QUICKDRAW2),
	ENUM2STRING(BOTH_SABERDRAW1),
	ENUM2STRING(BOTH_SABERDRAW2),
	ENUM2STRING(BOTH_SABERDRAW3),
	ENUM2STRING(BOTH_SABERDRAW4),
	ENUM2STRING(BOTH_SABERDRAW5),
	ENUM2STRING(BOTH_DJEMSO2),
	ENUM2STRING(BOTH_SHIEN3),
	ENUM2STRING(BOTH_SORESU2),
	ENUM2STRING(BOTH_SABERSTANCE2),
	ENUM2STRING(BOTH_SABERSTANCE3),
	ENUM2STRING(BOTH_DATAPAD),
	ENUM2STRING(BOTH_DATAPAD2),
	ENUM2STRING(BOTH_FACEPALM),
	ENUM2STRING(BOTH_FACEPALM2),
	ENUM2STRING(BOTH_READ),
	ENUM2STRING(BOTH_SITARMS),
	ENUM2STRING(BOTH_SITCROSS),
	ENUM2STRING(BOTH_SITCROSS2),
	ENUM2STRING(BOTH_SITLEAN),
	ENUM2STRING(BOTH_SITPALM),
	ENUM2STRING(BOTH_SITPALM2),
	ENUM2STRING(BOTH_PUSHUP),
	ENUM2STRING(BOTH_HELPEDUP),
	ENUM2STRING(BOTH_HELPUP),
	ENUM2STRING(BOTH_FORCECASUAL),
